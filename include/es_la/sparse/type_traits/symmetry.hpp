...
inline constexpr bool is_symmetry_tag =
	es_util::is_one_of<T, Not_symmetric, Structural_symmetric, Symmetric_upper, Symmetric_lower>;
...
struct Is_not_symmetric<Mkl_sparse_matrix<Matrix>> : Is_not_symmetric<es_util::Remove_cv_ref<Matrix>>
{};
...
template<class Matrix>
struct Is_structural_symmetric<Mkl_sparse_matrix<Matrix>> : Is_structural_symmetric<es_util::Remove_cv_ref<Matrix>>
{};
...
template<class Matrix>
struct Is_symmetric_upper<Mkl_sparse_matrix<Matrix>> : Is_symmetric_upper<es_util::Remove_cv_ref<Matrix>>
{};
...
template<class Matrix>
struct Is_symmetric_lower<Mkl_sparse_matrix<Matrix>> : Is_symmetric_lower<es_util::Remove_cv_ref<Matrix>>
{};
