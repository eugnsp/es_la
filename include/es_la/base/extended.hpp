...
class Extended<T_Derived, t_rows, 0> : public Expression<T_Derived>
{
public:
	static constexpr std::size_t rows();
...
class Extended<T_Derived, 0, t_cols> : public Expression<T_Derived>
{
public:
...
class Extended<T_Derived, 0, 0> : public Expression<T_Derived>
{
public:
	std::size_t rows() const;
	std::size_t cols() const;
